...
<!--
「でも当時は既存のフレームワークやライブラリを使いたくない、謎の厨二病にかかっていたんです。最小限に書いた方が早いし、Laravelは一見して複雑そうで覚えるのがめんどくさそうだと思っていました。今は時間が経ってLaravelの良さもわかりますが、当時はそう思っていたんです」
-->
...
### いろんな箇所から参照されて、どこで何が使われているか分からなくなった

<!--
「メソッドに細かく分割してみたんですが、それをいろんな箇所で参照するようになって、どこで何が使われているか分からなくなりました」
-->
