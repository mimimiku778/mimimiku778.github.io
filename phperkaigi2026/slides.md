...
## 自動インスタンス化もルーティングもセキュリティも

### 欲しい機能はすべて原理を調べて一から実装した

<!--
「自動インスタンス化もルーティングもセキュリティ対策も、欲しい機能はすべて原理を調べて一から実装しました」
-->
...
<!--
「自分が作ったもの、全部名前がついていました。URLに応じて処理を振り分ける仕組みは、ルーティングと呼ばれていました」
-->
