...
<!--
「でもフレームワークのありがたみを感じなかったんです。覚えるぐらいなら自分で作った方が早いと思いました」
-->
...
小学生の頃はWindows 2000のいらないサービスを消し
スマホはroot化して不要アプリを消す

#### いらないものを消せば速くなる

<!--
「昔からそういう気質でした。小学生の頃はWindowsのいらないサービスを消し、スマホはroot化して不要アプリを消す。いらないものを消せば速くなる」
-->
...
## 関数やメソッドの呼び出しが増えると遅くなる

### そう思っていた

<!--
「最初の頃は過剰にパフォーマンスを気にしていて、関数やメソッドの呼び出し回数が増えると遅くなると思っていました」
-->
...
### コードの書き方や抽象化は大したボトルネックではない

<!--
「でも実際に測ってみたら、数十個レベルでは全くと言っていいほど影響がなかったんです。想像の何倍もコードは速く実行される。コードの書き方や抽象化自体は大したボトルネックではないと分かりました」
-->
